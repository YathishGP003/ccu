...
import com.renovo.bacnet4j.type.constructed.LogStatus;
...
import com.renovo.bacnet4j.util.DeviceObjectPropertyReferences;
import com.renovo.bacnet4j.util.DeviceObjectPropertyValues;
import com.renovo.bacnet4j.util.PropertyValues;
...
public class TrendLogObject extends BACnetObject {
    ...
    protected boolean validateProperty(final ValueSource valueSource, final PropertyValue value)
        ...
        if (PropertyIdentifier.enable.equals(value.getPropertyIdentifier())) {
            ...
            System.out.println("Bacnet Trend log:"+loggingType);
            if (!loggingType.isOneOf(LoggingType.polled, LoggingType.cov) && !loggingType.isOneOf(new Enumerated(1),new Enumerated(0)) ) {
                throw new BACnetServiceException(ErrorClass.property, ErrorCode.writeAccessDenied);
            }
    ...
    public void makePropertyReadOnly(PropertyIdentifier propertyIdentifier){
        //addMixin(new CommandableMixin(this, propertyIdentifier));
    }
}
