...
import com.renovo.bacnet4j.apdu.ConfirmedRequest;
import com.renovo.bacnet4j.apdu.Reject;
import com.renovo.bacnet4j.apdu.SegmentACK;
import com.renovo.bacnet4j.apdu.Segmentable;
import com.renovo.bacnet4j.apdu.SimpleACK;
import com.renovo.bacnet4j.apdu.UnconfirmedRequest;
import com.renovo.bacnet4j.enums.MaxSegments;
import com.renovo.bacnet4j.exception.BACnetAbortException;
...
import com.renovo.bacnet4j.exception.CommunicationDisabledException;
        ...
        if (apdu instanceof ConfirmedRequest) {
            ...
            if (confAPDU.isSegmentedMessage()) {
                ...
                try {
                    ...
                    final com.renovo.bacnet4j.apdu.Error error = new com.renovo.bacnet4j.apdu.Error(
            ...
            if (ctx == null) {
                ...
                } else if (ack instanceof com.renovo.bacnet4j.apdu.Error)
                    consumer.fail(ack);
        ...
        try {
            try {
                ...
                network.sendAPDU(address, linkService,
                        new com.renovo.bacnet4j.apdu.Error(invokeId, e.getBacnetError()), false);
            } catch (final BACnetRejectException e) {
