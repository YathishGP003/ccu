...
do
		...
		echo "TASKID: " + $FILE1
		curl --request POST --url https://team75f.atlassian.net/rest/api/2/issue/$FILE1/transitions --header 'authorization: Basic Z2l0bGFiOkF5bmdheW42IQ==' --header 'cache-control: no-cache' --header 'content-type: application/json' --header 'postman-token: f55dcedb-cf92-2592-2a1c-d336e5c0f888' --data '{ "transition": {"id": "71"}}'
done
