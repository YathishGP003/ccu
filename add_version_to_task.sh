...
do
		...
		echo "TASKID: " + $FILE1
		curl --request POST --url https://team75f.atlassian.net/rest/api/2/issue/$FILE1/transitions --user ryan2@75f.io:BIpmwOmMfLbTbevVzNqjF5B1 --header 'cache-control: no-cache' --header 'content-type: application/json' --header 'postman-token: f55dcedb-cf92-2592-2a1c-d336e5c0f888' --data '{ "transition": {"id": "371"}}'
		curl --request POST --url https://team75f.atlassian.net/rest/api/2/issue/$FILE1/transitions --user ryan2@75f.io:BIpmwOmMfLbTbevVzNqjF5B1 --header 'cache-control: no-cache' --header 'content-type: application/json' --header 'postman-token: f55dcedb-cf92-2592-2a1c-d336e5c0f888' --data '{ "transition": {"id": "61"}}'
