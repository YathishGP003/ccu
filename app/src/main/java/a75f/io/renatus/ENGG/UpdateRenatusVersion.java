...
public class UpdateRenatusVersion extends Fragment {
    ...
    public void handleStartInstallUpdate() {
        ...
        CcuLog.d(L.TAG_CCU_DOWNLOAD, "got command to install update--"+DownloadManager.EXTRA_DOWNLOAD_ID +","+apkName);
        RenatusApp.getAppContext().registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(action)) {
                    ...
                    CcuLog.d(L.TAG_CCU_DOWNLOAD, String.format("Received download complete for %d from %d and %d", downloadId, AppInstaller.getHandle().getCCUAppDownloadId(), AppInstaller.getHandle().getDownloadedFileVersion(downloadId)));
