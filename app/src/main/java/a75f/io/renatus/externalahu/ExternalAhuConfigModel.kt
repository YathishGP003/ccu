...
class ExternalAhuConfigModel {
    ...
    fun toConfig(modelDef: SeventyFiveFProfileDirective) {
        heatingMinSp =
            getPointByDomainName(modelDef, systemHeatingSATMinimum)?.defaultValue.toString()
        heatingMaxSp =
            getPointByDomainName(modelDef, systemHeatingSATMaximum)?.defaultValue.toString()
        coolingMinSp =
            getPointByDomainName(modelDef, systemCoolingSATMinimum)?.defaultValue.toString()
        coolingMaxSp =
            getPointByDomainName(modelDef, systemCoolingSATMaximum)?.defaultValue.toString()
        fanMinSp =
            getPointByDomainName(modelDef, systemStaticPressureMinimum)?.defaultValue.toString()
        fanMaxSp =
            getPointByDomainName(modelDef, systemStaticPressureMaximum)?.defaultValue.toString()
        ...
        damperOpeningRate =
            getPointByDomainName(modelDef, systemCO2DamperOpeningRate)?.defaultValue.toString()
    }
}