 ...
 */
 ...
 data class ViewState(
        ...
        fun fromConfigTo(config: BaseProfileConfiguration, profileType: ProfileType): ViewState {
            ...
            when(profileType){
                ...
                ProfileType.HYPERSTAT_HEAT_PUMP_UNIT -> {
                    val configuration = config as HyperStatHpuConfiguration
                    return fromConfigHpu(configuration)
                }
    ...
    private fun toHpuConfig(): HyperStatHpuConfiguration {
        return HyperStatHpuConfiguration().apply {
            ...
            relay4State = HpuRelayState(relays[3].enabled,HpuRelayAssociation.values()[relays[3].association])
            relay5State = HpuRelayState(relays[4].enabled,HpuRelayAssociation.values()[relays[4].association])
            relay6State = HpuRelayState(relays[5].enabled,HpuRelayAssociation.values()[relays[5].association])


            analogOut1State = HpuAnalogOutState(
                analogOutUis[0].enabled,
                HpuAnalogOutAssociation.values()[analogOutUis[0].association],
                analogOutUis[0].voltageAtMin,analogOutUis[0].voltageAtMax,
                analogOutUis[0].perAtFanLow,analogOutUis[0].perAtFanMedium,analogOutUis[0].perAtFanHigh
            )
            analogOut2State = HpuAnalogOutState(
                analogOutUis[1].enabled,
                HpuAnalogOutAssociation.values()[analogOutUis[1].association],
                analogOutUis[1].voltageAtMin,analogOutUis[1].voltageAtMax,
                analogOutUis[1].perAtFanLow,analogOutUis[1].perAtFanMedium,analogOutUis[1].perAtFanHigh
            )
            analogOut3State = HpuAnalogOutState(
                analogOutUis[2].enabled,
                HpuAnalogOutAssociation.values()[analogOutUis[2].association],
                analogOutUis[2].voltageAtMin,analogOutUis[2].voltageAtMax,
                analogOutUis[2].perAtFanLow,analogOutUis[2].perAtFanMedium,analogOutUis[2].perAtFanHigh
            )
            analogIn1State = AnalogInState(analogIns[0].enabled,AnalogInAssociation.values()[analogIns[0].association])
...
val CpuAnalogOutAssociation.displayName: Int
    get() {
        return when (this) {
            ...
            CpuAnalogOutAssociation.MODULATING_FAN_SPEED -> R.string.linear_fan_speed
            CpuAnalogOutAssociation.HEATING -> R.string.heating
            CpuAnalogOutAssociation.DCV_DAMPER -> R.string.dcv_damper
            CpuAnalogOutAssociation.PREDEFINED_FAN_SPEED -> R.string.staged_fan_speed
        }
    }
    ...
    when(profileType){
        ProfileType.HYPERSTAT_CONVENTIONAL_PACKAGE_UNIT ->{
            when (enumValue) {
                ...
                CpuAnalogOutAssociation.MODULATING_FAN_SPEED.ordinal -> return R.string.linear_fan_speed
                ...
                CpuAnalogOutAssociation.PREDEFINED_FAN_SPEED.ordinal -> return R.string.staged_fan_speed
            }
        }
        ProfileType.HYPERSTAT_TWO_PIPE_FCU ->{
            when (enumValue) {
            ...
            when (enumValue) {
                HpuAnalogOutAssociation.FAN_SPEED.ordinal -> return R.string.fan_speed
                HpuAnalogOutAssociation.COMPRESSOR_SPEED.ordinal -> return R.string.compressor_speed
                HpuAnalogOutAssociation.DCV_DAMPER.ordinal -> return R.string.dcv_damper
            }
        }
        else -> {}
    }
