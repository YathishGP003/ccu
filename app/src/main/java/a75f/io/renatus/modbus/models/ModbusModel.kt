...
class EquipModel {
    ...
    val selectAllParameters_Left = mutableStateOf(false)
    val selectAllParameters_Right = mutableStateOf(false)
    val selectAllParameters_Left_subEquip = mutableListOf<RegisterItemForSubEquip>()
    val selectAllParameters_Right_subEquip = mutableListOf<RegisterItemForSubEquip>()
