                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            SpinnerElementOption(viewModel.viewState.value.zoneCO2Target.toInt()
                                .toString(),
                                co2ThresholdOptions,
                                co2Unit,
                                itemSelected = {
                                    viewModel.viewState.value.zoneCO2Target = it.value.toDouble()
                                },
                                viewModel = null
                            )
                        }
                        ...
                        Box(
                            ...
                            SpinnerElementOption(viewModel.viewState.value.zonePM2p5Target.toInt()
                                .toString(),
                                pm25ThresholdOptions,
                                pm25Unit,
                                itemSelected = {
                                    viewModel.viewState.value.zonePM2p5Target =
                                        it.value.toDouble()
                                },
                                viewModel = null
                            )
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            SpinnerElementOption(
                                viewModel.viewState.value.zonePM10Target.toInt()
                                    .toString(),
                                pm10TargetOptions,
                                pm10Unit,
                                itemSelected = {
                                    viewModel.viewState.value.zonePM10Target =
                                        it.value.toDouble()
                                },
                                viewModel = null
                            )
