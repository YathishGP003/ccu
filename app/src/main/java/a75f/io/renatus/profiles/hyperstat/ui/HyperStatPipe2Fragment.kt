...
class HyperStatPipe2Fragment : HyperStatFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(meshAddress: Short, roomName: String, floorName: String, nodeType: NodeType, profileType: ProfileType): HyperStatPipe2Fragment {
            val args = Bundle()
            ...
            val fragment = HyperStatPipe2Fragment()
    ...
    override val viewModel: HsPipe2ViewModel by viewModels()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        viewLifecycleOwner.lifecycleScope.launch(highPriorityDispatcher) {
            ...
            viewModel.setOnPairingCompleteListener(this@HyperStatPipe2Fragment)
            withContext(Dispatchers.Main) {
                rootView.setContent {
                    RootView()
                }
    ...
    override fun onPairingComplete() {
        this@HyperStatPipe2Fragment.closeAllBaseDialogFragments()
    }
}