...
class CpuViewModel(application: Application) : HyperStatViewModel(application) {
    ...
    override var viewState = mutableStateOf(CpuViewState() as ProfileViewState)
    ...
    private fun setConditioningMode(equip: HsCpuEquip) {
    ...
    private fun updateConditioningMode(equip: HsCpuEquip) {
