...
class HsHpuViewModel(application: Application) : HyperStatViewModel(application) {

    override var viewState = mutableStateOf(HpuViewState() as ProfileViewState)
    ...
    override fun saveConfiguration() {
        ...
        (viewState.value as HpuViewState).apply {
            logIt("Saving Configuration " + "$temperatureOffset  $isEnableAutoAway $isEnableAutoForceOccupied\n" +
                    ...
                    "co2Config $zoneCO2Threshold $zoneCO2Target\n" +
                    "pm2p5Config $zonePM2p5Target damperOpeningRate $zoneCO2DamperOpeningRate\n" +
                    ...
                    "$displayHumidity $displayCO2 $displayPM2p5"
    ...
    private fun setUpHpuProfile() {
        ...
        profileConfiguration.apply {
            ...
            val possibleFanMode = getHsPossibleFanModeSettings(getHpuFanLevel(profileConfiguration as HpuConfiguration))
            val equip = HsHpuEquip(equipId)
