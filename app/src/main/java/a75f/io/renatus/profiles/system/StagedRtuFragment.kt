...
open class StagedRtuFragment : Fragment() {
    ...
    fun StagedRtuRelayMappingView(viewModel: StagedRtuProfileViewModel) {
        ...
        SystemRelayMappingView(
            ...
            onRelayEnabled = {
                viewModel.viewState.value.relay1Enabled = it
            ...
            onMappingChanged = {
                viewModel.viewState.value.relay1Association = it
                viewModel.setStateChanged()
            },
        ...
        SystemRelayMappingView(
            ...
            onRelayEnabled = {
                viewModel.viewState.value.relay2Enabled = it
                viewModel.setStateChanged()
                viewModel.viewState.value.unusedPortState =
            ...
            mapping = viewModel.relay1AssociationList,
            onMappingChanged = {
                viewModel.viewState.value.relay2Association = it
                viewModel.setStateChanged()
            },
        ...
        SystemRelayMappingView(
            ...
            onRelayEnabled = {
                viewModel.viewState.value.relay3Enabled = it
                viewModel.setStateChanged()
                viewModel.viewState.value.unusedPortState =
        ...
        SystemRelayMappingView(
            ...
            onRelayEnabled = {
                viewModel.viewState.value.relay4Enabled = it
                viewModel.setStateChanged()
                viewModel.viewState.value.unusedPortState =
            ...
            mapping = viewModel.relay1AssociationList,
            onMappingChanged = {
                viewModel.viewState.value.relay4Association = it
                viewModel.setStateChanged()
            },
        ...
        SystemRelayMappingView(
            ...
            onRelayEnabled = {
                viewModel.viewState.value.relay5Enabled = it
                viewModel.setStateChanged()
                viewModel.viewState.value.unusedPortState =
            ...
            mapping = viewModel.relay1AssociationList,
            onMappingChanged = {
                viewModel.viewState.value.relay5Association = it
                viewModel.setStateChanged()
            },
        ...
        SystemRelayMappingView(
            ...
            onRelayEnabled = {
                viewModel.viewState.value.relay6Enabled = it
                viewModel.setStateChanged()
                viewModel.viewState.value.unusedPortState =
            ...
            mapping = viewModel.relay1AssociationList,
            onMappingChanged = {
                viewModel.viewState.value.relay6Association = it
                viewModel.setStateChanged()
            },
        ...
        SystemRelayMappingView(
            ...
            onRelayEnabled = {
                viewModel.viewState.value.relay7Enabled = it
                viewModel.setStateChanged()
                viewModel.viewState.value.unusedPortState =
