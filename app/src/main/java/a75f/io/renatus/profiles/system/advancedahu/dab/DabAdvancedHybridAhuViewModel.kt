...
class DabAdvancedHybridAhuViewModel : AdvancedHybridAhuViewModel() {
    ...
    fun init(context: Context, hayStack: CCUHsApi) {
        super.init(context, ModelLoader.getDabAdvancedAhuCmModelV2(), ModelLoader.getDabAdvancedAhuConnectModelV2(), hayStack)
    ...
    private fun createNewEquip(id: String): String {
        ...
        val existingConnectEquip = hayStack.readEntity("domainName == \"" + DomainName.dabAdvancedHybridAhuV2_connectModule + "\"")
