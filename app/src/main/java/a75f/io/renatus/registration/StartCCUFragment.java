...
public class StartCCUFragment extends Fragment {
    ...
    public static StartCCUFragment newInstance(String param1, String param2) {
        StartCCUFragment fragment = new StartCCUFragment();
