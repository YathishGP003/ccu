 ...
 * Use {@link Builder} to create an instance of WizardFlow.
 */
public class WizardFlow {
	 ...
	 * eventually call {@link Builder#create()} to create the instance.
	 */
	public static class Builder {
		 ...
		 * call {@link Builder#setActivity} before adding a step to the flow.
		 *
		 * @param stepClass
