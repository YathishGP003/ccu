...
*/
	...
	public void testHarness() {
		...
		String state = "{\n" + "  \"controlMote\" : {\n" + "    \"controlMoteOutputInput\" : \"Control Mote settings go here\"\n" + "  },\n" + "  \"defaultSite\" : {\n" + "    \"tz\" : \"Chicago\",\n" + "    \"displayName\" : \"ddscd\",\n" + "    \"geoAddress\" : null,\n" + "    \"geoCity\" : \"jfknf\",\n" + "    \"geoState\" : \"MN\",\n" + "    \"geoZip\" : \"ndjdjd\",\n" + "    \"markers\" : null,\n" + "    \"area\" : 10000.0\n" + "  },\n" + "  \"systemProfile\" : {\n" + "    \"@type\" : \"VavFullyModulatingRtu\",\n" + "    \"analog1Enabled\" : false,\n" + "    \"analog2Enabled\" : false,\n" + "    \"analog3Enabled\" : false,\n" + "    \"analog4Enabled\" : false\n" + "  },\n" + "  \"floors\" : [ {\n" + "    \"mZoneList\" : [ {\n" + "      \"mZoneProfiles\" : [ {\n" + "        \"clazz\" : \"a75f.io.logic.bo.building.vav.VavReheatProfile\",\n" + "        \"profileConfiguration\" : {\n" + "          \"7000\" : {\n" + "            \"clazz\" : \"a75f.io.logic.bo.building.vav.VavProfileConfiguration\",\n" + "            \"priority\" : 1,\n" + "            \"maxDamperHeating\" : 80,\n" + "            \"minDamperCooling\" : 40,\n" + "            \"minDamperHeating\" : 40,\n" + "            \"maxDamperCooliing\" : 80,\n" + "            \"inputs\" : [ ],\n" + "            \"nodeAddress\" : 7000,\n" + "            \"nodeType\" : \"SMART_NODE\",\n" + "            \"outputs\" : [ {\n" + "              \"uuid\" : \"17280d56-230a-4e71-8e8e-f65a96f5fa23\",\n" + "              \"mOutputAnalogActuatorType\" : \"ZeroToTenV\",\n" + "              \"address\" : 7000,\n" + "              \"name\" : \"\",\n" + "              \"port\" : \"ANALOG_OUT_ONE\",\n" + "              \"logicalValue\" : 0.0,\n" + "              \"namedSchedule\" : \"\",\n" + "              \"overrideMillis\" : 0,\n" + "              \"overrideType\" : \"NONE\",\n" + "              \"scheduleMode\" : \"ZoneSchedule\",\n" + "              \"schedules\" : [ ]\n" + "            }, {\n" + "              \"uuid\" : \"6e5c341f-f4bc-40f0-9449-b526b9512835\",\n" + "              \"mOutputAnalogActuatorType\" : \"ZeroToTenV\",\n" + "              \"address\" : 7000,\n" + "              \"name\" : \"\",\n" + "              \"port\" : \"ANALOG_OUT_TWO\",\n" + "              \"logicalValue\" : 0.0,\n" + "              \"namedSchedule\" : \"\",\n" + "              \"overrideMillis\" : 0,\n" + "              \"overrideType\" : \"NONE\",\n" + "              \"scheduleMode\" : \"ZoneSchedule\",\n" + "              \"schedules\" : [ ]\n" + "            }, {\n" + "              \"uuid\" : \"3869faf1-1651-4511-a9b8-588d7a9bf5c1\",\n" + "              \"mOutputRelayActuatorType\" : \"NormallyOpen\",\n" + "              \"address\" : 7000,\n" + "              \"name\" : \"\",\n" + "              \"port\" : \"RELAY_ONE\",\n" + "              \"logicalValue\" : 0.0,\n" + "              \"namedSchedule\" : \"\",\n" + "              \"overrideMillis\" : 0,\n" + "              \"overrideType\" : \"NONE\",\n" + "              \"scheduleMode\" : \"ZoneSchedule\",\n" + "              \"schedules\" : [ ]\n" + "            } ]\n" + "          }\n" + "        },\n" + "        \"logicalValue\" : 0.0,\n" + "        \"namedSchedule\" : \"\",\n" + "        \"overrideMillis\" : 0,\n" + "        \"overrideType\" : \"NONE\",\n" + "        \"scheduleMode\" : \"ZoneSchedule\",\n" + "        \"schedules\" : [ ]\n" + "      } ],\n" + "      \"mZoneRef\" : \"@4e293504-95b9-40c5-b057-3617ca74870a\",\n" + "      \"roomName\" : \"zzzz1111\",\n" + "      \"nodes\" : [ 7000 ],\n" + "      \"tuningParameters\" : { }\n" + "    }, {\n" + "      \"mZoneProfiles\" : [ {\n" + "        \"clazz\" : \"a75f.io.logic.bo.building.vav.VavReheatProfile\",\n" + "        \"profileConfiguration\" : {\n" + "          \"7001\" : {\n" + "            \"clazz\" : \"a75f.io.logic.bo.building.vav.VavProfileConfiguration\",\n" + "            \"priority\" : 1,\n" + "            \"maxDamperHeating\" : 80,\n" + "            \"minDamperCooling\" : 40,\n" + "            \"minDamperHeating\" : 40,\n" + "            \"maxDamperCooliing\" : 80,\n" + "            \"inputs\" : [ ],\n" + "            \"nodeAddress\" : 7001,\n" + "            \"nodeType\" : \"SMART_NODE\",\n" + "            \"outputs\" : [ {\n" + "              \"uuid\" : \"a77540df-7f89-4099-9888-6d6243cf3204\",\n" + "              \"mOutputAnalogActuatorType\" : \"ZeroToTenV\",\n" + "              \"address\" : 7001,\n" + "              \"name\" : \"\",\n" + "              \"port\" : \"ANALOG_OUT_ONE\",\n" + "              \"logicalValue\" : 0.0,\n" + "              \"namedSchedule\" : \"\",\n" + "              \"overrideMillis\" : 0,\n" + "              \"overrideType\" : \"NONE\",\n" + "              \"scheduleMode\" : \"ZoneSchedule\",\n" + "              \"schedules\" : [ ]\n" + "            }, {\n" + "              \"uuid\" : \"5a0aa10d-0e61-40f5-b421-d1a6222d07e2\",\n" + "              \"mOutputAnalogActuatorType\" : \"ZeroToTenV\",\n" + "              \"address\" : 7001,\n" + "              \"name\" : \"\",\n" + "              \"port\" : \"ANALOG_OUT_TWO\",\n" + "              \"logicalValue\" : 0.0,\n" + "              \"namedSchedule\" : \"\",\n" + "              \"overrideMillis\" : 0,\n" + "              \"overrideType\" : \"NONE\",\n" + "              \"scheduleMode\" : \"ZoneSchedule\",\n" + "              \"schedules\" : [ ]\n" + "            }, {\n" + "              \"uuid\" : \"c15069b6-8887-48e7-8bb1-dd389b0ea14f\",\n" + "              \"mOutputRelayActuatorType\" : \"NormallyOpen\",\n" + "              \"address\" : 7001,\n" + "              \"name\" : \"\",\n" + "              \"port\" : \"RELAY_ONE\",\n" + "              \"logicalValue\" : 0.0,\n" + "              \"namedSchedule\" : \"\",\n" + "              \"overrideMillis\" : 0,\n" + "              \"overrideType\" : \"NONE\",\n" + "              \"scheduleMode\" : \"ZoneSchedule\",\n" + "              \"schedules\" : [ ]\n" + "            } ]\n" + "          }\n" + "        },\n" + "        \"logicalValue\" : 0.0,\n" + "        \"namedSchedule\" : \"\",\n" + "        \"overrideMillis\" : 0,\n" + "        \"overrideType\" : \"NONE\",\n" + "        \"scheduleMode\" : \"ZoneSchedule\",\n" + "        \"schedules\" : [ ]\n" + "      } ],\n" + "      \"mZoneRef\" : \"@d1e49a3b-3a83-4c95-a52f-605281fb487c\",\n" + "      \"roomName\" : \"zzzzz2222\",\n" + "      \"nodes\" : [ 7001 ],\n" + "      \"tuningParameters\" : { }\n" + "    } ],\n" + "    \"mFloorName\" : \"ffffff\",\n" + "    \"mFloorRef\" : \"@edcfe40e-322b-46e8-b2fe-cca769ad84ad\",\n" + "    \"mFloorId\" : 0\n" + "  } ],\n" + "  \"smartNodeAddressBand\" : 7000,\n" + "  \"testTimeDoW\" : 0,\n" + "  \"testTimeHH\" : 0,\n" + "  \"testTimeMM\" : 0,\n" + "  \"title\" : \"\"\n" + "}";
		
		try
		{
			CCUApplication appStruct = (CCUApplication) JsonSerializer.fromJson(state, CCUApplication.class);
	...
	public void sendFirmwareMetadata() {
		...
		message.metadata.majorVersion.set((short)0);
