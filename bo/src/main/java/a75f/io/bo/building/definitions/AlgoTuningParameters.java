...
public class AlgoTuningParameters
{
    ...
    public int getmMinLightingControlOverrideInMinutes()
    {
        return mMinLightingControlOverrideInMinutes;
    }
    public void setmMinLightingControlOverrideInMinutes(int mMinLightingControlOverrideInMinutes)
    {
        this.mMinLightingControlOverrideInMinutes = mMinLightingControlOverrideInMinutes;
    }
    public int getmLightingIntensityForOccupancyDetect()
    {
        return mLightingIntensityForOccupancyDetect;
    }
    public void setmLightingIntensityForOccupancyDetect(int mLightingIntensityForOccupancyDetect)
    {
