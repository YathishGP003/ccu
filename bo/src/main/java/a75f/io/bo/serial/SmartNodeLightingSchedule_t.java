...
public class SmartNodeLightingSchedule_t extends Struct {
    ...
    public final Unsigned8[] logicalName =
            array (new Unsigned8[MessageConstants.MAX_LIGHTING_CONTROL_CIRCUIT_LOGICAL_NAME_BYTES]);
    ...
    public final LightingScheduleEntry_t[] entries =
                array (new LightingScheduleEntry_t[MessageConstants.MAX_LIGHTING_CONTROL_CIRCUIT_SCHEDULE_ENTRIES]);
