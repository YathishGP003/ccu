 ...
 */
    ...
    short mSensorAddress = 2000;
    byte[] encryptionKey = {0x06, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07,
    ...
    public void test_() throws Exception {
        ...
        seedMessage.encryptionKey.set(ByteBuffer.wrap(encryptionKey));
...
//        System.out.println(seedMessage.toString());
    ...
    byte[] getPairingByteArray(byte msg, boolean bNewPairing)
    {
        int nCounter = 0;
            msg = (byte) MessageType.CCU_TO_CM_OVER_USB_DATABASE_SEED_SN.ordinal();
            ...
            nCounter = fillSmartNodeControls(nCounter, byteArray, false);
            return byteArray;
    ...
    private int fillSmartNodeControls(int nCounter, byte[] byteArray, boolean restartDevice) {
    ...
    private int fillSmartNodeSettings(int nCounter, byte[] byteArray) {
        ...
        int power_in = 0x01;
        int power_out = 0x02;
        int analogIn1 = 0, analogIn2 = 0, thermister1 = 0, thermister2 = 0, relay1 = 0, relay2 = 0, analogOut1 = 0, analogOut2 = 0;
        ...
        analogOut1 = 0x40;
        analogOut2 = 0x80;
        analogIn1 = true ? 0x04 : 0x00;
        analogIn2 = true ? 0x08 : 0x00;
        int power24v1 = analogIn1 > 0 ? 0x400 : 0x00;
        int power24v2 = analogOut1 > 0 ? 0x800 : 0x00;
        int logo = 0x00;
        ...
        byteArray[nCounter++] = (byte) (relay1
                ...
                | power24v2
                | logo);
        byteArray[nCounter++] = (byte) (0x04 &  0xff); //OAO Profile only
...
//        System.arraycopy(nullTerminator, 0, value, inputBytes.length, nullTerminator.length);
    ...
    private byte[] nullTerminateByteArray(byte[] inputBytes) {
