...
import static a75f.io.dal.DalContext.getSharedClient;
import static a75f.io.dal.JsonSerializer.fromJson;
...
public class DALTest
{
    ...
    private void testSavingTuningParametersActual()
    {
        try
        {
            InputStream inputStream = context.getAssets().open("DefaultTuningParameters_v100.json");
            AlgoTuningParameters algoTuningParameters =
                    JsonSerializer.fromJson(inputStream, AlgoTuningParameters.class);
            Assert.assertTrue((int) algoTuningParameters.getAlgoTuningParameters()
            ...
            final DataStore<AlgoTuningParameters> schedulesDataStore = DataStore
                                                                               .collection(Constants.TUNERS_COLLECTION_NAME,
                                                                                       AlgoTuningParameters.class,
                                                                                       StoreType.NETWORK,
                                                                                       DalContext.getSharedClient());
    ...
    public void testDalUserParsing()
    {
        try
        {
            ...
            User user = fromJson(inputStream, User.class);
