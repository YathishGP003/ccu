...
public class CmToCcuOverUsbCmRegularUpdateMessage_t extends Struct
{
	...
	public final Unsigned16 thermistor_1 = new Unsigned16(); // external voltage sense in mv units
	
	public final Unsigned16 thermistor_2 = new Unsigned16(); // external voltage sense in mv units
