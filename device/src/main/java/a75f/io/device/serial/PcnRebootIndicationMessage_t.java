...
/**
 * Created by pramod isOn 13-10-2025. 
 */

public class PcnRebootIndicationMessage_t extends Struct
{
	 ...
	 */
	public final Enum8<FirmwareDeviceType_t> smartNodeDeviceType           = new Enum8<>(FirmwareDeviceType_t.values());
	...
	public final Unsigned8                   serverId = new Unsigned8();
	@Override
