...
/**
 * Created by Yinten on 2/12/2018.
 */

public class SNRegularUpdateMessage_t extends Struct {
    ...
    public final SensorReading_t[] sensorReadings = array(new SensorReading_t[MessageConstants.NUM_SN_TYPE_VALUE_SENSOR_READINGS]);
