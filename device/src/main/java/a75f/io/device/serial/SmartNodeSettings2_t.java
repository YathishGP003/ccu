...
public class SmartNodeSettings2_t extends Struct {
    ...
    public final Enum4<DamperShape_t> damperShape = new Enum4<>(DamperShape_t.values()); ///< Refer to DamperShape_t. Default - Round
    public final Enum4<CondensateSensor_t> condensateSensor = new Enum4<>(CondensateSensor_t.values()); ///< Refer to CondensateSensor_t. Default - Normally Open
