...
class ConnectModuleEquip (equipRef : String) : DomainEquip(equipRef) {
    ...
    */
    ...
    val oaoreturnAirCo2 = Point(DomainName.returnAirCo2, equipRef)
    ...
    val oaooutsideTemperature = Point(DomainName.outsideTemperature, equipRef)
    val oaomixedAirTemperature = Point(DomainName.mixedAirTemperature, equipRef)
    ...
    val oaoCo2DamperOpeningRate = Point(DomainName.co2DamperOpeningRate, equipRef)
