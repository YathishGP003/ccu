...
object ModelLoader {
    ...
    fun getDabStageRtuModelDef() : ModelDirective {
        return ModelCache.getModelById(MODEL_DAB_STAGED_RTU)
    }
    ...
    fun getHyperStatPipe4Model() : ModelDirective {
        return ModelCache.getModelById(MODEL_HYPERSTAT_PIPE4)
    }
