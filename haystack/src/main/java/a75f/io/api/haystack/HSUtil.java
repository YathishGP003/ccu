...
public class HSUtil {
 ...
 public static boolean isHSPipe4Equip(String id, CCUHsApi hayStack) {
        HashMap<Object, Object> equipMap = hayStack.readMapById(id);
        return isHsEquip(equipMap.get(EQUIPREF).toString(), hayStack) && equipMap.containsKey(Tags.PIPE4);
    }
    ...
    public static boolean isHyperStatSplitEquip(String id, CCUHsApi hayStack) {
        HashMap<Object, Object> equipMap = hayStack.readMapById(id);
        HashMap<Object, Object> equip = hayStack.readMapById(equipMap.get("equipRef").toString());
        return equip.containsKey(Tags.ECONOMIZER) && (equip.containsKey(Tags.CPU) || equip.containsKey(Tags.PIPE4) || equip.containsKey(Tags.PIPE2));
    }
