...
/**
 * Created by samjithsadasivan on 9/7/18.
 */

/**
 * All the haystack tags are to be updated here.
 *
 * The first char must be ASCII lower case letter.  Rest of
 * chars must be ASCII letter, digit, or underscore.
 */
public class Tags
{
    ...
    public static final String BACNET_OBJECT_ID = "bacnetObjectId";
    ...
    public static final String BACNET_CUR = "bacnetCur";
    public static final String BACNET_MSTP = "bacnetMstp";
    ...
    public static final String CCU_SYSTEM_SCREEN = "CCU_SYSTEM_SCREEN";
