...
{
    private ArrayList<HashMap<Object, Object>> mRows;
    ...
    private final ArrayList<Equip>        equips        = new ArrayList<>();
    private final ArrayList<Device>       devices       = new ArrayList<>();
    private final ArrayList<Point>        points        = new ArrayList<>();
    private final ArrayList<RawPoint>     phyPoints     = new ArrayList<>();
    private final ArrayList<SettingPoint> settingPoints = new ArrayList<>();
    ...
    public Entity getNext() {
        ...
        HashMap<Object, Object> m = mRows.get(index++);
        if (m.get("site") != null) {
