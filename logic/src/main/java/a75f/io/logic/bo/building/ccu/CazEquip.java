...
public class CazEquip
{
    ...
    public void createEntities(CazProfileConfig config, String floorRef, String roomRef)
    {
        ...
        Equip.Builder b = new Equip.Builder()
                ...
                .addMarker("equip").addMarker("ti").addMarker("zone").addMarker("equipHis")
                .setAhuRef(ahuRef)
                .setTz(tz)
        ...
        Point equipStatusMessage = new Point.Builder()
                ...
                .setRoomRef(roomRef)
                .setFloorRef(floorRef)
                .addMarker("status").addMarker("message").addMarker("ti").addMarker("writable").addMarker("logical").addMarker("zone").addMarker("equipHis")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .setKind("string")
                .build();
        ...
        Point equipScheduleStatus = new Point.Builder()
                ...
                .setRoomRef(roomRef)
                .setFloorRef(floorRef)
                .addMarker("scheduleStatus").addMarker("logical").addMarker("ti").addMarker("zone").addMarker("writable").addMarker("his").addMarker("equipHis")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .setKind("string")
                .build();
        ...
        Point dischargeAirTemp1 = new Point.Builder()
                ...
                .setFloorRef(floorRef)
                .addMarker("zone").addMarker("ti")
                .addMarker("air").addMarker("temp").addMarker("sensor").addMarker("th1").addMarker("his").addMarker("logical").addMarker("equipHis")
                .setGroup(String.valueOf(nodeAddr))
                .setUnit("\u00B0F")
                .setTz(tz)
                .build();
