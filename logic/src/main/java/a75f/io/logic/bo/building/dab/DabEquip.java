...
public class DabEquip
{
    ...
    public void createEntities(DabProfileConfiguration config, String floorRef, String roomRef)
    {
        ...
        DabTuners.addEquipDabTuners(siteRef, siteDis + "-DAB-" + nodeAddr, equipRef, roomRef, floorRef, tz);
        ...
        Point damper1Pos = new Point.Builder()
                                  ...
                                  .addMarker("damper").addMarker("primary").addMarker("dab").addMarker("base").addMarker("cmd").addMarker("his").addMarker("logical").addMarker("zone")
                                  .setGroup(String.valueOf(nodeAddr))
                                  .setUnit("%")
                                  .setTz(tz)
                                  .build();
        ...
        Point damper2Pos = new Point.Builder()
                                  ...
                                  .setFloorRef(floorRef)
                                  .setHisInterpolate("cov")
                                  .addMarker("damper").addMarker("secondary").addMarker("dab").addMarker("base").addMarker("cmd").addMarker("his").addMarker("logical").addMarker("zone")
                                  .setGroup(String.valueOf(nodeAddr))
                                  .setUnit("%")
                                  .setTz(tz)
                                  .build();
        ...
        Point normalizedDamper1Pos = new Point.Builder()
                                            ...
                                            .setFloorRef(floorRef)
                                            .setHisInterpolate("cov")
                                            .addMarker("damper").addMarker("primary").addMarker("dab").addMarker("normalized").addMarker("cmd").addMarker("his").addMarker("logical").addMarker("zone")
                                            .setGroup(String.valueOf(nodeAddr))
                                            .setUnit("%")
                                            .setTz(tz)
                                            .build();
        ...
        Point normalizedDamper2Pos = new Point.Builder()
                                             ...
                                             .setFloorRef(floorRef)
                                             .setHisInterpolate("cov")
                                             .addMarker("damper").addMarker("secondary").addMarker("dab").addMarker("normalized").addMarker("cmd").addMarker("his").addMarker("logical").addMarker("zone")
                                             .setGroup(String.valueOf(nodeAddr))
                                             .setUnit("%")
                                             .setTz(tz)
                                             .build();
        ...
        Point equipScheduleType = new Point.Builder()
                                          ...
                                          .setRoomRef(roomRef)
                                          .setFloorRef(floorRef).setHisInterpolate("cov")
                                          .addMarker("zone").addMarker("dab").addMarker("scheduleType").addMarker("writable").addMarker("his")
                                          .setGroup(String.valueOf(nodeAddr))
