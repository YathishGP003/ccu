...
public enum Port
{
	RELAY_ONE, aRELAY_TWO, RELAY_THREE, RELAY_FOUR, RELAY_FIVE, RELAY_SIX, RELAY_SEVEN, RELAY_EIGHT,
	...
	SENSOR_NO2, SENSOR_PM2P5, SENSOR_PM10, ANALOG_OUT_THREE, ANALOG_OUT_FOUR;
