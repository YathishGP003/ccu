...
public enum ProfileType
{
    ...
    SYSTEM_VAV_ADVANCED_AHU, SYSTEM_DAB_ADVANCED_AHU, BACNET_DEFAULT, MYSTAT_PIPE2,MYSTAT_CPU,MYSTAT_HPU, CONNECTNODE,HYPERSTATSPLIT_4PIPE_UV, HYPERSTATSPLIT_2PIPE_UV, PCN, MYSTAT_PIPE4;
    ...
    public static String getProfileDescription(ProfileType profileType) {
        ...
        switch (profileType) {
            ...
            case MYSTAT_HPU:
                return "MyStat Heat Pump Unit";
            case MYSTAT_PIPE2:
                return "MyStat Pipe2 FCU";
            case OTN:
                return "TemperatureInfluencing";
            case HYPERSTATSPLIT_2PIPE_UV:
                return "2Pipe Unit Ventilation";
            case HYPERSTATSPLIT_4PIPE_UV:
                return "4Pipe Unit Ventilation";
            case MYSTAT_PIPE4:
                return "MyStat Pipe4 FCU";
            default:
