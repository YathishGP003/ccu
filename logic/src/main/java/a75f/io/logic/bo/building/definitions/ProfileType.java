...
public enum ProfileType
{
    ...
    HYPERSTAT_CONVENTIONAL_PACKAGE_UNIT,
    ...
    MODBUS_UPS40K,MODBUS_UPSL,MODBUS_UPSV,MODBUS_UPSVL,MODBUS_VAV_BACnet,
    HYPERSTAT_SENSE
    MODBUS_UPS40K,MODBUS_UPSL,MODBUS_UPSV,MODBUS_UPSVL,MODBUS_VAV_BACnet, MODBUS_DEFAULT
}
