...
public enum ProfileType
{
    ...
    SYSTEM_VAV_ADVANCED_AHU, SYSTEM_DAB_ADVANCED_AHU, BACNET_DEFAULT, MYSTAT_PIPE2,MYSTAT_CPU,MYSTAT_HPU, CONNECTNODE,HYPERSTATSPLIT_4PIPE_UV, HYPERSTATSPLIT_2PIPE_UV, MYSTAT_PIPE4;
