...
class CpuReconfiguration {
    ...
    companion object {
        ...
        private fun updateConfig(current: HyperStatCpuConfiguration, portType: Port, status: Double): HyperStatCpuConfiguration{
        ...
        private fun updateAssociation(current: HyperStatCpuConfiguration, portType: Port, association: Int): HyperStatCpuConfiguration{
            val config = getConfigCopy(current)
            when(portType){
                Port.RELAY_ONE -> config.relay1State = config.relay1State.copy(association = CpuRelayAssociation.values()[association])
                Port.RELAY_TWO -> config.relay2State = config.relay2State.copy(association = CpuRelayAssociation.values()[association])
                Port.RELAY_THREE -> config.relay3State = config.relay3State.copy(association = CpuRelayAssociation.values()[association])
                Port.RELAY_FOUR -> config.relay4State = config.relay4State.copy(association = CpuRelayAssociation.values()[association])
                Port.RELAY_FIVE -> config.relay5State = config.relay5State.copy(association = CpuRelayAssociation.values()[association])
                Port.RELAY_SIX -> config.relay6State = config.relay6State.copy(association = CpuRelayAssociation.values()[association])
                Port.ANALOG_OUT_ONE -> config.analogOut1State = config.analogOut1State.copy(association =  CpuAnalogOutAssociation.values()[association])
                Port.ANALOG_OUT_TWO -> config.analogOut2State = config.analogOut2State.copy(association = CpuAnalogOutAssociation.values()[association])
        ...
        private fun getConfigCopy(original:HyperStatCpuConfiguration ): HyperStatCpuConfiguration {
