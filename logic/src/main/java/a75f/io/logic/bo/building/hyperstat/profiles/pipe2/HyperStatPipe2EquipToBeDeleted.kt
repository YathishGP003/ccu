...
class HyperStatPipe2EquipToBeDeleted(val node: Short): HyperStatEquipToBeDeleted()  {
    ...
    companion object {
        fun getHyperStatEquipRef(nodeAddress: Short): HyperStatPipe2EquipToBeDeleted {
            val equip = HyperStatPipe2EquipToBeDeleted(nodeAddress)
    ...
    private fun configHyperStatDevice(config: HyperStatPipe2Configuration, profileEquip: HyperStatEquipToBeDeleted) {
    ...
    private fun getThermistorInConfigurations(config: HyperStatPipe2Configuration) {
        ...
        config.thermistorIn2State = Pipe2Th2InState(
            th2 == 1, HyperStatAssociationUtil.getPipe2Th2InStage()
        )
    }
