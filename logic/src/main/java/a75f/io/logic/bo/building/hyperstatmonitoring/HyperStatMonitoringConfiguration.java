...
public class HyperStatMonitoringConfiguration extends BaseProfileConfiguration {
    ...
    public int analog2Sensor;
    public int th1Sensor;
    public int th2Sensor;
    public boolean isAnalog1Enable;
    public boolean isAnalog2Enable;
    public boolean isTh1Enable;
    public boolean isTh2Enable;
