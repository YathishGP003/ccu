...
enum class CpuControlType {
    COOLING, LINEAR_FAN, HEATING, OAO_DAMPER, STAGED_FAN, RETURN_DAMPER
}

enum class CpuRelayType {
    COOLING_STAGE1, COOLING_STAGE2, COOLING_STAGE3, HEATING_STAGE1, HEATING_STAGE2, HEATING_STAGE3, FAN_LOW_SPEED, FAN_MEDIUM_SPEED, FAN_HIGH_SPEED, FAN_ENABLED, OCCUPIED_ENABLED, HUMIDIFIER, DEHUMIDIFIER, EX_FAN_STAGE1, EX_FAN_STAGE2, DCV_DAMPER
}
...
enum class CpuUniInType {
    ...
    EMERGENCY_SHUTOFF_NO, EMERGENCY_SHUTOFF_NC, GENERIC_ALARM_NO, GENERIC_ALARM_NC, INDEX_95, INDEX_96, INDEX_97, INDEX_98, INDEX_99, INDEX_100,
}
