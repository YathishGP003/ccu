package a75f.io.logic.bo.building.mystat.profiles.fancoilunit.pipe2
...
import a75f.io.logic.bo.building.mystat.profiles.fancoilunit.MyStatFanCoilUnit
import a75f.io.logic.bo.building.mystat.profiles.fancoilunit.getMyStatAnalogOutputPoints
import a75f.io.logic.bo.building.mystat.profiles.fancoilunit.getMyStatRelayOutputPoints
...
import a75f.io.logic.bo.building.mystat.profiles.util.milliToMin
...
class MyStatPipe2Profile: MyStatFanCoilUnit() {
    ...
    private fun operateRelays(
        config: MyStatPipe2Configuration, tuner: MyStatTuners, userIntents: MyStatUserIntents, basicSettings: MyStatBasicSettings,
    ...
    private fun handleRelayState(
        ...
        userIntents: MyStatUserIntents, basicSettings: MyStatBasicSettings, relayStages: HashMap<String, Int>,
    ...
    private fun waterValveLoop(userIntents: MyStatUserIntents): Int {
    ...
    private fun runAlgorithm(
        ...
        analogOutStages: HashMap<String, Int>, configuration: MyStatPipe2Configuration, userIntents: MyStatUserIntents
    ) {
        // Run water sampling
