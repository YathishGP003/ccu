...
import a75f.io.logic.bo.building.mystat.configs.MyStatCpuAnalogOutConfigs
...
import a75f.io.logic.bo.building.mystat.profiles.packageunit.getMyStatCpuAnalogOutputPoints
import a75f.io.logic.bo.building.mystat.profiles.packageunit.getMyStatCpuRelayOutputPoints
...
class MyStatCpuProfile: MyStatPackageUnitProfile() {
    ...
    private fun getPercentFromVolt(voltage: Int, min: Int = 0, max: Int = 10) = (((voltage - min).toDouble() / (max - min)) * 100).roundToInt()
