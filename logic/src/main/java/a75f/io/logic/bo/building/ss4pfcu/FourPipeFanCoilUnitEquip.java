...
public class FourPipeFanCoilUnitEquip  {
    ...
    FourPipeFanCoilUnitProfile ss4PfcUnit;
    ...
    public FourPipeFanCoilUnitEquip(ProfileType T, int node) {

        profileType = T;
        ss4PfcUnit = new FourPipeFanCoilUnitProfile();
        nodeAddr = node;
    ...
    public void createHaystackPoints(FourPipeFanCoilUnitConfiguration config, String floor, String room) {
        ...
        Point eatPoint = new Point.Builder()
                ...
                .setRoomRef(room)
                .setFloorRef(floor).setHisInterpolate("cov")
                .addMarker("standalone").addMarker(profile).addMarker("fcu").addMarker("his")
        ...
        Point heatingStage1 = new Point.Builder()
                .setDisplayName(equipDis+"-heatingWaterValve")
                .setEquipRef(equipRef)
                .setSiteRef(siteRef)
                .setRoomRef(room)
                .setFloorRef(floor).setHisInterpolate("cov")
        ...
        Point equipScheduleType = new Point.Builder()
                ...
                .setRoomRef(room)
                .setFloorRef(floor).setHisInterpolate("cov")
                .addMarker("zone").addMarker("scheduleType").addMarker("writable").addMarker("zone").addMarker("his").addMarker(profile).addMarker("fcu")
                .setGroup(String.valueOf(nodeAddr))
...
//initialize with default values if schedule fetch is null
    ...
    private void addProfilePoints(String siteRef, String equipref, String equipDis, String tz,String floor, String room) {
        ...
        Point fourPfcuConditioningMode = new Point.Builder()
    ...
    public void createFourPipeConfigPoints(FourPipeFanCoilUnitConfiguration config, String equipRef, String floor, String room) {
        HashMap siteMap = CCUHsApi.getInstance().read(Tags.SITE);
        String siteRef = (String) siteMap.get(Tags.ID);
        String siteDis = (String) siteMap.get("dis");
        String equipDis = siteDis+"-4PFCU-"+nodeAddr;
        ...
        Point external10KProbeTh2 = new Point.Builder()
                ...
                .addMarker("enable").addMarker(profile).addMarker("fcu").addMarker("his")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .build();
        ...
        Point enableRelay4 = new Point.Builder()
                .setDisplayName(equipDis+"-enableHeatingWaterValve")
                .setEquipRef(equipRef)
                .setSiteRef(siteRef)
                .setFloorRef(floor)
                .setRoomRef(room)
        ...
        Point enableRelay6 = new Point.Builder()
                .setDisplayName(equipDis+"-enableCoolingWaterValve")
                .setEquipRef(equipRef)
                .setSiteRef(siteRef)
                .setFloorRef(floor)
                .setRoomRef(room)
    ...
    public void updateHaystackPoints(FourPipeFanCoilUnitConfiguration config) {
    ...
    public FourPipeFanCoilUnitConfiguration getProfileConfiguration() {
    ...
    private void updateUserIntentPoints(FourPipeFanCoilUnitConfiguration config, String equipRef) {
        ...
        if (!config.enableRelay4) {
            if (curCondMode == SSEConditioningMode.AUTO.ordinal() || curCondMode == SSEConditioningMode.HEAT_ONLY.ordinal() ) {
                fallbackMode = SSEConditioningMode.OFF.ordinal();
            }
        } else if (!config.enableRelay6){
    ...
    private static SSEFanStage getMaxAvailableFanSpeed(FourPipeFanCoilUnitConfiguration config) {
