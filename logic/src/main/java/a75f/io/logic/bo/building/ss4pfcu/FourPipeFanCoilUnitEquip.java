...
//initialize with default values if schedule fetch is null
    ...
    private void addProfilePoints(String siteRef, String equipref, String equipDis, String tz,String floor, String room) {
        ...
        Point fourPfcuConditioningMode = new Point.Builder()
                ...
                .setRoomRef(room)
                .setFloorRef(floor)
                .addMarker("standalone").addMarker("temp").addMarker("operating").addMarker("mode").addMarker("his").addMarker("equipHis").addMarker("sp").addMarker("zone").addMarker("fcu").addMarker("pipe4")
    ...
    public void updateHaystackPoints(FourPipeFanCoilUnitConfiguration config) {
        ...
        if(config.enableOccupancyControl){
            Point occupancyDetection = new Point.Builder()
                    ...
                    .addMarker("occupancy").addMarker("detection").addMarker("fcu").addMarker("pipe4").addMarker("his").addMarker("zone").addMarker("equipHis")
                    .setGroup(String.valueOf(nodeAddr))
                    .setEnums("false,true")
                    .setTz(tz)
                    .build();
