...
public class ConventionalUnitLogicalMap {
    ...
    public void createHaystackPoints(ConventionalUnitConfiguration config, String floor, String room) {
        ...
        Point datPoint = new Point.Builder()
                ...
                .setRoomRef(room)
                .setFloorRef(floor).setHisInterpolate("cov")
                .addMarker("standalone").addMarker(profile).addMarker("discharge")
        ...
        Point coolingStage2 = new Point.Builder()
                ...
                .setRoomRef(room)
                .setFloorRef(floor).setHisInterpolate("cov")
                .addMarker("standalone").addMarker("cooling").addMarker("stage2").addMarker("his").addMarker("zone").addMarker("runtime")
                .addMarker("logical").addMarker(profile).addMarker("cmd")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .build();
        ...
        Point heatingStage2 = new Point.Builder()
                ...
                .setRoomRef(room)
                .setFloorRef(floor).setHisInterpolate("cov")
                .addMarker("standalone").addMarker("heating").addMarker("stage2").addMarker("his").addMarker("zone").addMarker("runtime")
                .addMarker("logical").addMarker(profile).addMarker("cmd")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .build();
        ...
        Point equipScheduleType = new Point.Builder()
                                          ...
                                          .setRoomRef(room)
                                          .setFloorRef(floor).setHisInterpolate("cov")
                                          .addMarker("zone").addMarker("cpu").addMarker("scheduleType").addMarker("writable").addMarker("his")
                                          .setGroup(String.valueOf(nodeAddr))
...
///Create Physical points and map
        ...
        switch (fanRelayType){
            case FAN_STAGE2:
                Point fanStage2pt = new Point.Builder().setDisplayName(equipDis+"-fanStage2").setEquipRef(equipRef).setSiteRef(siteRef).setRoomRef(room).setFloorRef(floor).setHisInterpolate("cov")
                        .addMarker("standalone").addMarker("fan").addMarker("stage2").addMarker("his").addMarker("zone").addMarker("logical").addMarker(profile).addMarker("cmd").addMarker("runtime")
                        .setGroup(String.valueOf(nodeAddr))
                        .setTz(tz)
                        .build();
            ...
            case HUMIDIFIER:
                Point humidifier = new Point.Builder().setDisplayName(equipDis+"-humidifier").setEquipRef(equipRef).setSiteRef(siteRef).setRoomRef(room).setFloorRef(floor).setHisInterpolate("cov")
                        .addMarker("standalone").addMarker("humidifier").addMarker("his").addMarker("zone").addMarker("logical").addMarker(profile).addMarker("cmd")
                        .setEnums("off,on")
                        .setGroup(String.valueOf(nodeAddr))
                        .setTz(tz)
                        .build();
            ...
            case DE_HUMIDIFIER:
                Point dehumidifier = new Point.Builder().setDisplayName(equipDis+"-deHumidifier").setEquipRef(equipRef).setSiteRef(siteRef).setRoomRef(room).setFloorRef(floor).setHisInterpolate("cov")
                        .addMarker("standalone").addMarker("dehumidifier").addMarker("his").addMarker("zone").addMarker("logical").addMarker(profile).addMarker("cmd")
                        .setEnums("off,on")
                        .setGroup(String.valueOf(nodeAddr))
                        .setTz(tz)
                        .build();
...
//initialize with default values if schedule fetch is null
    ...
    private void addProfilePoints(String siteRef, String equipref, String equipDis, String tz,String floor, String room) {
        Point cpuOccupancy = new Point.Builder()
                ...
                .setRoomRef(room)
                .setFloorRef(floor).setHisInterpolate("cov")
                .addMarker("standalone").addMarker("occupancy").addMarker("mode")
    ...
    public void createConventionalConfigPoints(ConventionalUnitConfiguration config, String equipRef, String floor, String room) {
        ...
        Point external10KProbeTh2 = new Point.Builder()
                ...
                .setFloorRef(floor)
                .setRoomRef(room)
                .addMarker("config").addMarker("standalone").addMarker("writable").addMarker("zone").addMarker("th2")
                .addMarker("sp").addMarker("enable").addMarker(profile).addMarker("his")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .build();
    ...
    protected void addUserIntentPoints(String equipref, String equipDis, String room, String floor,
        ...
        Point fanOpMode = new Point.Builder()
                ...
                .addMarker("cpu").addMarker("zone").setGroup(String.valueOf(nodeAddr))
        ...
        Point operationalMode = new Point.Builder()
                ...
                .addMarker("cpu").addMarker("temp").setGroup(String.valueOf(nodeAddr))
        ...
        Point targetHumidty = new Point.Builder()
                                    ...
                                    .setSiteRef(siteRef).setEquipRef(equipref)
                                    .setHisInterpolate("cov").setGroup(String.valueOf(nodeAddr))
                                    .addMarker("standalone").addMarker("userIntent").addMarker("writable")
