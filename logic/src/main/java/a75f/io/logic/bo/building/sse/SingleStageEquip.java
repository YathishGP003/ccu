...
public class SingleStageEquip {
    ...
    public void createHaystackPoints(SingleStageConfig config, String floorRef, String roomRef) {
        ...
        Equip.Builder b = new Equip.Builder()
                ...
                .addMarker("equip").addMarker("sse").addMarker("zone").addMarker("equipHis")
                .setAhuRef(ahuRef)
                .setTz(tz)
        ...
        Point equipStatusMessage = new Point.Builder()
                ...
                .setRoomRef(roomRef)
                .setFloorRef(floorRef)
                .addMarker("status").addMarker("message").addMarker("sse").addMarker("writable").addMarker("logical").addMarker("zone").addMarker("equipHis").addMarker("his")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .setKind("string")
                .build();
        ...
        Point equipScheduleStatus = new Point.Builder()
                ...
                .setRoomRef(roomRef)
                .setFloorRef(floorRef)
                .addMarker("scheduleStatus").addMarker("logical").addMarker("sse").addMarker("zone").addMarker("writable").addMarker("his").addMarker("equipHis")
                .setGroup(String.valueOf(nodeAddr))
                .setTz(tz)
                .setKind("string")
                .build();
