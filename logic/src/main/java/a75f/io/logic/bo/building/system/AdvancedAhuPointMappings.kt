...
enum class AdvancedAhuRelayMappings {
    LOAD_COOLING_STAGE_1,
    LOAD_COOLING_STAGE_2,
    LOAD_COOLING_STAGE_3,
    LOAD_COOLING_STAGE_4,
    LOAD_COOLING_STAGE_5,
    LOAD_HEATING_STAGE_1,
    LOAD_HEATING_STAGE_2,
    LOAD_HEATING_STAGE_3,
    LOAD_HEATING_STAGE_4,
    LOAD_HEATING_STAGE_5,
    LOAD_FAN_STAGE_1,
    LOAD_FAN_STAGE_2,
    LOAD_FAN_STAGE_3,
    LOAD_FAN_STAGE_4,
    ...
    SAT_HEATING_STAGE_4,
    SAT_HEATING_STAGE_5,
    FAN_PRESSURE_STAGE_1,
    FAN_PRESSURE_STAGE_2,
    FAN_PRESSURE_STAGE_3,
    FAN_PRESSURE_STAGE_4,
