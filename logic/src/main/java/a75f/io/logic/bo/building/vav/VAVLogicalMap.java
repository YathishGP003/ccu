...
public class VAVLogicalMap
{
    ...
    public void createHaystackPoints(VavProfileConfiguration config, String floor, String room) {
        ...
        Point datPoint = new Point.Builder()
                                ...
                                .addMarker("air").addMarker("temp").addMarker("sensor").addMarker("his").addMarker("cur").addMarker("logical").addMarker("zone").addMarker("equipHis")
                                .setGroup(String.valueOf(nodeAddr))
                                .setUnit("\u00B0F")
                                .setTz(tz)
                                .build();
        ...
        Point occupancy = new Point.Builder()
                                    ...
                                    .setRoomRef(room)
                                    .setFloorRef(floor).setHisInterpolate("cov")
                                    .addMarker("vav").addMarker("occupancy").addMarker("mode").addMarker("zone").addMarker("his").addMarker("equipHis")
                                    .setGroup(String.valueOf(nodeAddr))
