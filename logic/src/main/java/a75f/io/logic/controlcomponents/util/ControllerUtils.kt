...
class ControllerNames {
    ...
    companion object {
        ...
        const val COOLING_VALVE_CONTROLLER = "COOLING_VALVE_CONTROLLER"
        const val HEATING_VALVE_CONTROLLER = "HEATING_VALVE_CONTROLLER"
        const val FACE_BYPASS_CONTROLLER = "FACE_BYPASS_CONTROLLER"
