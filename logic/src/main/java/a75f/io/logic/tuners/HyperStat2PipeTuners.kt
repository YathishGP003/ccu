    ...
    companion object{
        ...
        private fun addPipe2SpecificTuners(
            ...
            val auxHeating1Activate = Point.Builder()
                ...
                .setMinVal("0").setMaxVal("10").setIncrementVal("1").addMarker("default")
            ...
            val sa2PfcHeatingThreshold = Point.Builder()
                ...
                .addMarker("tuner").addMarker("default").addMarker("base").addMarker("writable")
            ...
            val waterValveSamplingOnTime = Point.Builder()
                ...
                .setMinVal("0").setMaxVal("150").setIncrementVal("1").addMarker("default")
                .setTunerGroup(TunerConstants.HYPERSTAT_TUNER_GROUP)
                .setUnit("m")
                .setTz(tz)
            if(isModuleTuner) {
