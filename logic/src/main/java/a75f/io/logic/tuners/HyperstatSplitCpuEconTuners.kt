 ...
 */
class HyperstatSplitCpuEconTuners {
    ...
    companion object {
        ...
        // Adding Hyperstat Split Default tuners

        fun addHyperstatSplitDefaultTuners(
        ...
        private fun addHyperStatSplitModuleDefaultTuners(
            hayStack: CCUHsApi, siteRef: String, equipRef: String, equipDis: String, tz: String
        ) {
        ...
        fun addHyperStatSplitModuleTuners(
            ...
            addHyperStatSplitModuleDefaultTuners(hayStack, siteRef, equipRef, equipDis, tz)
        }
