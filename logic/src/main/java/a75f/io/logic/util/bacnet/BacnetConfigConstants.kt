...
object  BacnetConfigConstants {
    ...
    const val BACNET_PERIODIC_RESUBSCRIBE_COV = "bacnetPeriodicResubscribeCov"
    const val BACNET_JOB_TASK_TYPE = "bacnetJobTaskType"
    ...
    const val BACNET_BBMD_CONFIGURATION_BACKUP = "bacnetBbmdConfigurationBackup"
    const val BACNET_MSTP_CONFIGURATION = "bacnetMstpConfiguration"
    const val BACNET_FD_CONFIGURATION = "bacnetFdConfiguration"
    const val BACNET_FD_CONFIGURATION_BACKUP = "bacnetFdConfigurationBackup"
