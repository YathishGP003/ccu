...
class HyperStatAssociationUtilTest {
    ...
    fun isRelayAssociatedToFanTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isRelayAssociatedToFan(
                RelayState(
                    true,
    ...
    fun isRelayAssociatedToCoolingStageTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isRelayAssociatedToCoolingStage(
                RelayState(
                    true,
                    CpuRelayAssociation.COOLING_STAGE_1
                )
    ...
    fun isRelayAssociatedToHeatingStageTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isRelayAssociatedToHeatingStage(
                RelayState(
                    true,
    ...
    fun getRelayAssociatedStageTest() {
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(0),
            CpuRelayAssociation.COOLING_STAGE_1
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(1),
            CpuRelayAssociation.COOLING_STAGE_2
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(2),
            CpuRelayAssociation.COOLING_STAGE_3
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(3),
            CpuRelayAssociation.HEATING_STAGE_1
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(4),
            CpuRelayAssociation.HEATING_STAGE_2
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(5),
            CpuRelayAssociation.HEATING_STAGE_3
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(6),
            CpuRelayAssociation.FAN_LOW_SPEED
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(7),
            CpuRelayAssociation.FAN_MEDIUM_SPEED
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(8),
            CpuRelayAssociation.FAN_HIGH_SPEED
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(9),
            CpuRelayAssociation.FAN_ENABLED
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(10),
            CpuRelayAssociation.OCCUPIED_ENABLED
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(11),
            CpuRelayAssociation.HUMIDIFIER
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getRelayAssociatedStage(12),
            CpuRelayAssociation.DEHUMIDIFIER
        )
    }
    ...
    fun getAnalogOutAssociatedStageTest() {
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogOutAssociatedStage(0),
            CpuAnalogOutAssociation.COOLING
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogOutAssociatedStage(1),
            CpuAnalogOutAssociation.MODULATING_FAN_SPEED
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogOutAssociatedStage(2),
            CpuAnalogOutAssociation.HEATING
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogOutAssociatedStage(3),
            CpuAnalogOutAssociation.DCV_DAMPER
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogOutAssociatedStage(4),
    ...
    fun getAnalogInStageTest() {
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogInStage(0),
            AnalogInAssociation.CURRENT_TX_0_10
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogInStage(1),
            AnalogInAssociation.CURRENT_TX_0_20
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogInStage(2),
            AnalogInAssociation.CURRENT_TX_0_50
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogInStage(3),
            AnalogInAssociation.KEY_CARD_SENSOR
        )
        Assert.assertEquals(
            HyperStatAssociationUtil.getAnalogInStage(4),
            AnalogInAssociation.DOOR_WINDOW_SENSOR
        )
    }
    ...
    fun isRelayAssociatedToFanEnabledTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isRelayAssociatedToFanEnabled(
                RelayState(
                    true,
                    CpuRelayAssociation.FAN_ENABLED
                )
    ...
    fun isRelayAssociatedToOccupiedEnabledTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isRelayAssociatedToOccupiedEnabled(
                RelayState(
                    true,
                    CpuRelayAssociation.OCCUPIED_ENABLED
                )
    ...
    fun isRelayAssociatedToHumidifierTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isRelayAssociatedToHumidifier(
                RelayState(
                    true,
                    CpuRelayAssociation.HUMIDIFIER
                )
    ...
    fun isRelayAssociatedToDeHumidifierTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isRelayAssociatedToDeHumidifier(
                RelayState(
                    true,
                    CpuRelayAssociation.DEHUMIDIFIER
                )
...
*/
    ...
    fun isAnalogInAssociatedToCurrentTX10Test() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isAnalogInAssociatedToCurrentTX10(
                AnalogInState(
                    true,
                    AnalogInAssociation.CURRENT_TX_0_10
                )
    ...
    fun isAnalogInAssociatedToCurrentTX20Test() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isAnalogInAssociatedToCurrentTX20(
                AnalogInState(
                    true,
                    AnalogInAssociation.CURRENT_TX_0_20
                )
    ...
    fun isAnalogInAssociatedToCurrentTX50Test() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isAnalogInAssociatedToCurrentTX50(
                AnalogInState(
                    true,
                    AnalogInAssociation.CURRENT_TX_0_50
                )
    ...
    fun isAnalogInAssociatedToDoorWindowSensorTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isAnalogInAssociatedToDoorWindowSensor(
                AnalogInState(
                    true,
                    AnalogInAssociation.DOOR_WINDOW_SENSOR
                )
    ...
    fun isAnalogInAssociatedToKeyCardSensorTest() {
        Assert.assertEquals(
            true,
            HyperStatAssociationUtil.isAnalogInAssociatedToKeyCardSensor(
                AnalogInState(
                    true,
                    AnalogInAssociation.KEY_CARD_SENSOR
                )
    ...
    fun isBothRelayHasSameConfigsTest() {
        Assert.assertEquals(
            true, HyperStatAssociationUtil.isBothRelayHasSameConfigs(
        ...
        Assert.assertEquals(
            false, HyperStatAssociationUtil.isBothRelayHasSameConfigs(
    ...
    fun isBothAnalogInHasSameConfigsTest() {
        Assert.assertEquals(
            true, HyperStatAssociationUtil.isBothAnalogInHasSameConfigs(
        ...
        Assert.assertEquals(
            false, HyperStatAssociationUtil.isBothAnalogInHasSameConfigs(
                AnalogInState(true, AnalogInAssociation.KEY_CARD_SENSOR),
    ...
    fun isAnyRelayAssociatedToHumidifierTest() {
        ...
        Assert.assertEquals(
            false,
            HyperStatAssociationUtil.isAnyRelayAssociatedToHumidifier(configuration)
        )
    ...
    fun isAnyRelayAssociatedToDeHumidifierTest() {
        ...
        Assert.assertEquals(
            false,
            HyperStatAssociationUtil.isAnyRelayAssociatedToDeHumidifier(configuration)
        )
    ...
    fun isAnyRelayEnabledAssociatedToFanTest() {
        ...
        Assert.assertEquals(
            false,
            HyperStatAssociationUtil.isAnyRelayEnabledAssociatedToFan(configuration)
        )
