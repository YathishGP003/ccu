    ...
    private void handlePbMessage(JsonObject msg, Context context){
        ...
        switch (cmd) {
            ...
            case RemoteCommandUpdateHandler.CMD:
                ...
                break;
            case AlertMessageHandlers.CREATE_CUSTOM_ALERT_DEF_CMD:
            case AlertMessageHandlers.UPDATE_CUSTOM_ALERT_DEF_CMD:
                alertMessageHandler().handleCustomAlertDefMessage(msg);
                break;
            case AlertMessageHandlers.REMOVE_ALERT_CMD:
            case AlertMessageHandlers.REMOVE_ALERTS_CMD:
                alertMessageHandler().handleAlertRemoveMessage(cmd, msg);
                break;
            case AlertMessageHandlers.CREATE_PREDEFINED_ALERT_DEF_CMD:
            case AlertMessageHandlers.UPDATE_PREDEFINED_ALERT_DEF_CMD:
            case AlertMessageHandlers.DELETE_PREDEFINED_ALERT_DEF_CMD:
                alertMessageHandler().handlePredefinedAlertDefMessage(msg);
                break;
            case AlertMessageHandlers.DELETE_CUSTOM_ALERT_DEF_CMD:
            case AlertMessageHandlers.DELETE_SITE_DEFS_CMD:
