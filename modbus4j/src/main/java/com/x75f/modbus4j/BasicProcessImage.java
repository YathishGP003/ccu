...
import com.x75f.modbus4j.base.RangeAndOffset;
...
import com.x75f.modbus4j.locator.StringLocator;
...
public class BasicProcessImage implements ProcessImage {
     ...
     * <p>addListener.</p>
     *
     * @param l a {@link com.x75f.modbus4j.ProcessImageListener} object.
     */
     ...
     * @param bit a int.
     * @return a boolean.
     * @throws com.x75f.modbus4j.exception.IllegalDataAddressException if any.
     */
     ...
     * <p>getRegister.</p>
     *
     * @param locator a {@link com.x75f.modbus4j.locator.BaseLocator} object.
     * @param <T> a T object.
     * @return a T object.
     * @throws com.x75f.modbus4j.exception.IllegalDataAddressException if any.
     */
