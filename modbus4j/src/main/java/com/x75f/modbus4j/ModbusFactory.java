...
import com.x75f.modbus4j.exception.ModbusIdException;
import com.x75f.modbus4j.exception.ModbusTransportException;
import com.x75f.modbus4j.ip.IpParameters;
import com.x75f.modbus4j.ip.listener.TcpListener;
import com.x75f.modbus4j.ip.tcp.TcpMaster;
import com.x75f.modbus4j.ip.tcp.TcpSlave;
import com.x75f.modbus4j.ip.udp.UdpMaster;
import com.x75f.modbus4j.ip.udp.UdpSlave;
...
import com.x75f.modbus4j.serial.ascii.AsciiMaster;
import com.x75f.modbus4j.serial.ascii.AsciiSlave;
import com.x75f.modbus4j.serial.rtu.RtuMaster;
import com.x75f.modbus4j.serial.rtu.RtuSlave;
...
public class ModbusFactory {
     ...
     * @return a {@link com.x75f.modbus4j.ModbusMaster} object.
     */
    public ModbusMaster createRtuMaster(SerialPortWrapper wrapper) {
        return new RtuMaster(wrapper);
    }
    public ModbusMaster createRtuMaster() {
        return new RtuMaster();
    }
    /**
     ...
     *
     * @param wrapper a {@link com.x75f.modbus4j.serial.SerialPortWrapper} object.
     * @return a {@link com.x75f.modbus4j.ModbusSlaveSet} object.
     */
     ...
     * @param offset a int.
     * @param length a int.
     * @return a {@link com.x75f.modbus4j.msg.ModbusRequest} object.
     * @throws com.x75f.modbus4j.exception.ModbusTransportException if any.
     * @throws com.x75f.modbus4j.exception.ModbusIdException if any.
     */
