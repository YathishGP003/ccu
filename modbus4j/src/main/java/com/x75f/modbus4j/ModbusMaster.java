...
import com.x75f.modbus4j.base.KeyedModbusLocator;
import com.x75f.modbus4j.base.ReadFunctionGroup;
import com.x75f.modbus4j.base.SlaveProfile;
import com.x75f.modbus4j.code.DataType;
import com.x75f.modbus4j.code.ExceptionCode;
import com.x75f.modbus4j.code.FunctionCode;
import com.x75f.modbus4j.code.RegisterRange;
import com.x75f.modbus4j.exception.ErrorResponseException;
import com.x75f.modbus4j.exception.InvalidDataConversionException;
import com.x75f.modbus4j.exception.ModbusInitException;
import com.x75f.modbus4j.exception.ModbusTransportException;
import com.x75f.modbus4j.locator.BaseLocator;
import com.x75f.modbus4j.locator.BinaryLocator;
import com.x75f.modbus4j.locator.NumericLocator;
...
import com.x75f.modbus4j.msg.ReadResponse;
import com.x75f.modbus4j.msg.WriteCoilRequest;
import com.x75f.modbus4j.msg.WriteCoilsRequest;
import com.x75f.modbus4j.msg.WriteMaskRegisterRequest;
import com.x75f.modbus4j.msg.WriteRegisterRequest;
import com.x75f.modbus4j.msg.WriteRegistersRequest;
import com.x75f.modbus4j.sero.epoll.InputStreamEPollWrapper;
import com.x75f.modbus4j.sero.log.BaseIOLog;
import com.x75f.modbus4j.sero.messaging.MessageControl;
import com.x75f.modbus4j.sero.util.ArrayUtils;
import com.x75f.modbus4j.sero.util.ProgressiveTask;
...
abstract public class ModbusMaster extends Modbus {
     ...
     * <p>init.</p>
     *
     * @throws com.x75f.modbus4j.exception.ModbusInitException if any.
     */
     ...
     * <p>send.</p>
     *
     * @param request a {@link com.x75f.modbus4j.msg.ModbusRequest} object.
     * @return a {@link com.x75f.modbus4j.msg.ModbusResponse} object.
     * @throws com.x75f.modbus4j.exception.ModbusTransportException if any.
     */
     ...
     * @throws com.x75f.modbus4j.exception.ModbusTransportException
     *             if there was an IO error or other technical failure while sending the message
     * @throws com.x75f.modbus4j.exception.ErrorResponseException
     ...
     *
     * @param l a {@link com.x75f.modbus4j.NodeScanListener} object.
     * @return a {@link com.x75f.modbus4j.sero.util.ProgressiveTask} object.
     */
     ...
     *
     * @return a {@link com.x75f.modbus4j.sero.log.BaseIOLog} object.
     */
     ...
     *
     * @param ioLog a {@link com.x75f.modbus4j.sero.log.BaseIOLog} object.
     */
     ...
     *
     * @return a {@link com.x75f.modbus4j.sero.epoll.InputStreamEPollWrapper} object.
     */
     ...
     *
     * @param ePoll a {@link com.x75f.modbus4j.sero.epoll.InputStreamEPollWrapper} object.
     */
     ...
     *
     * @param batch a {@link com.x75f.modbus4j.BatchRead} object.
     * @return a {@link com.x75f.modbus4j.BatchResults} object.
     * @throws com.x75f.modbus4j.exception.ModbusTransportException if any.
     * @throws com.x75f.modbus4j.exception.ErrorResponseException if any.
     ...
     *
     * @return a {@link com.x75f.modbus4j.sero.messaging.MessageControl} object.
     */
     ...
     *
     * @param conn a {@link com.x75f.modbus4j.sero.messaging.MessageControl} object.
     */
