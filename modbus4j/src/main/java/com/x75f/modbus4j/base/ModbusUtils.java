...
public class ModbusUtils {
     ...
     * <p>checkCRC.</p>
     *
     * @param modbusMessage a {@link com.x75f.modbus4j.msg.ModbusMessage} object.
     * @param queue a {@link com.x75f.modbus4j.sero.util.queue.ByteQueue} object.
     * @throws com.x75f.modbus4j.exception.ModbusTransportException if any.
     */
    ...
    public static int calculateCRC(int nextByte, int low, int high) {
        int uIndex;
        uIndex = high ^ nextByte;
        high = low ^ lookupCRCHi[uIndex];
        low = lookupCRCLo[uIndex];
