package com.x75f.modbus4j.ip.encap;

import com.x75f.modbus4j.ip.IpMessage;
import com.x75f.modbus4j.msg.ModbusMessage;
import com.x75f.modbus4j.sero.messaging.IncomingResponseMessage;
import com.x75f.modbus4j.sero.messaging.OutgoingRequestMessage;
import com.x75f.modbus4j.sero.messaging.WaitingRoomKey;
...
public class EncapWaitingRoomKeyFactory implements WaitingRoomKeyFactory {
     ...
     *
     * @param msg a {@link com.x75f.modbus4j.msg.ModbusMessage} object.
     * @return a {@link com.x75f.modbus4j.sero.messaging.WaitingRoomKey} object.
     */
