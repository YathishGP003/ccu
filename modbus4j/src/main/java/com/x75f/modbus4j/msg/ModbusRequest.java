 ...
 */
package com.x75f.modbus4j.msg;

import com.x75f.modbus4j.Modbus;
import com.x75f.modbus4j.ProcessImage;
...
import com.x75f.modbus4j.exception.IllegalDataAddressException;
...
abstract public class ModbusRequest extends ModbusMessage {
     ...
     *
     * @param queue a {@link com.x75f.modbus4j.sero.util.queue.ByteQueue} object.
     ...
     * <p>validate.</p>
     *
     * @param modbus a {@link com.x75f.modbus4j.Modbus} object.
     * @throws com.x75f.modbus4j.exception.ModbusTransportException if any.
     */
     ...
     * <p>handle.</p>
     *
     * @param processImage a {@link com.x75f.modbus4j.ProcessImage} object.
