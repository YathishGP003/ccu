 ...
 */
package com.x75f.modbus4j.serial;
...
abstract public class SerialSlave extends ModbusSlaveSet {
    ...
    public void start() throws ModbusInitException {
        try {
            ...
            System.out.println("CCU_SERIAL"+ " start transport: " +  transport);
        }
        catch (Exception e) {
            System.out.println("SerialSlave stop exception="+e.getMessage());
            System.out.println("CCU_SERIAL"+ " start SerialSlave: " +  e.getMessage());
    ...
    public void stop() {
        try {
			...
			System.out.println("SerialSlave stop exception="+e.getMessage());
            System.out.println("CCU_SERIAL"+ " stop SerialSlave: " +  e.getMessage());
		}
    }
}
