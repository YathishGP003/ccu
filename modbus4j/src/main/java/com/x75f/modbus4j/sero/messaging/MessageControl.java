...
import com.x75f.modbus4j.sero.io.StreamUtils;
import com.x75f.modbus4j.sero.log.BaseIOLog;
import com.x75f.modbus4j.sero.timer.SystemTimeSource;
import com.x75f.modbus4j.sero.timer.TimeSource;
...
public class MessageControl implements DataConsumer {
     ...
     * <p>start.</p>
     *
     * @param transport a {@link com.x75f.modbus4j.sero.messaging.Transport} object.
     * @param messageParser a {@link com.x75f.modbus4j.sero.messaging.MessageParser} object.
     * @param handler a {@link com.x75f.modbus4j.sero.messaging.RequestHandler} object.
     * @param waitingRoomKeyFactory a {@link com.x75f.modbus4j.sero.messaging.WaitingRoomKeyFactory} object.
     ...
     *
     * @param exceptionHandler a {@link com.x75f.modbus4j.sero.messaging.MessagingExceptionHandler} object.
     */
     ...
     *
     * @return a {@link com.x75f.modbus4j.sero.timer.TimeSource} object.
     */
     ...
     *
     * @param timeSource a {@link com.x75f.modbus4j.sero.timer.TimeSource} object.
     */
     ...
     * <p>send.</p>
     *
     * @param request a {@link com.x75f.modbus4j.sero.messaging.OutgoingRequestMessage} object.
     * @return a {@link com.x75f.modbus4j.sero.messaging.IncomingResponseMessage} object.
     * @throws IOException if any.
     */
    ...
    public IncomingResponseMessage send(OutgoingRequestMessage request, int timeout, int retries) throws IOException {
        ...
        //if (DEBUG)
            System.out.println("Serial MessagingControl.send: " + StreamUtils.dumpHex(data));
            ...
            try {
                do {
                    ...
                    if (/*DEBUG &&*/ response == null)
                        System.out.println("Serial Timeout waiting for response");
                }
     ...
     * <p>send.</p>
     *
     * @param response a {@link com.x75f.modbus4j.sero.messaging.OutgoingResponseMessage} object.
     * @throws IOException if any.
     */
