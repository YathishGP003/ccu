...
public class SmartNodeParams
{
    ...
    public int sensor_reading_1_data;
    public int sensor_reading_2_type;
    public int sensor_reading_2_data;
    public int sensor_reading_3_type;
    public int sensor_reading_3_data;
    public int sensor_reading_4_type;
    public int sensor_reading_4_data;
    public int sensor_reading_5_type;
    public int sensor_reading_5_data;
