 ...
 */
public class UsbModbusServiceCom2 extends Service {

    public static final String TAG = "CCU_USB_MODBUS2";
    ...
    private final BroadcastReceiver usbReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context arg0, Intent arg1) {
            if (arg1.getAction().equals(ACTION_USB_PERMISSION)) {
                ...
                if (UsbSerialUtil.getModbusDeviceCom2(attachedDevice, UsbPrefHelper.getUsbDeviceList(context)) != null
                                            && !serialPortConnected) {
                ...
                if (UsbSerialUtil.getModbusDeviceCom2(detachedDevice, UsbPrefHelper.getUsbDeviceList(context)) != null) {
    ...
    private void messageToClients(byte[] data, boolean isModbusData) {
        ...
        if (isModbusData)
            serialAction = SerialAction.MESSAGE_FROM_SERIAL_MODBUS2;
    ...
    public void onCreate() {
        ...
        serialPortConnected = false;
        UsbModbusServiceCom2.SERVICE_CONNECTED = true;
        setFilter();
        ...
        try {
            ...
            Intent intent = new Intent(ACTION_USB_PERMISSION_NOT_GRANTED);
            UsbModbusServiceCom2.this.getApplicationContext().sendBroadcast(intent);
        }
    ...
    public void onDestroy() {
        ...
        serialPortConnected = false;
        UsbModbusServiceCom2.SERVICE_CONNECTED = false;
        super.onDestroy();
        if (serialPort != null) {
    ...
    private void findModbusSerialPortDevice() {
        ...
        if (usbDevices.size() == 1 ) {
            CcuLog.d(TAG, "Only one USB device connected");
            return;
        }
        ...
        if (!usbDevices.isEmpty()) {
            ...
            for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
                ...
                usbModbusDevice= UsbSerialUtil.getModbusDeviceCom2(device, configuredUsbDevices);
    ...
    public class UsbBinder extends Binder {
        public UsbModbusServiceCom2 getService() {
            return UsbModbusServiceCom2.this;
        }
    }
